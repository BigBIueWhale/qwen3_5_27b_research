...
I researched the current state of Qwen 3.5 support on Ollama's `main` branch extensively, and as of v0.17.4 (the newest stable release) there are still four critical bugs that make the model's agentic capabilities completely non-functional. I've filed a detailed issue with source-level analysis covering all four: [ollama/ollama#14493](https://github.com/ollama/ollama/issues/14493)
