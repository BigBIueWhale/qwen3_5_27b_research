...
- [**Example: Math Olympiad Proof**](example_math_olympiad_unsloth_ud.md) — Qwen 3.5 27B (Unsloth UD-Q4_K_XL) produces a rigorous, self-contained proof of non-existence for a constrained decagon problem. Uses cyclotomic polynomial divisibility, a parity argument via evaluation at $x=-1$, and a degree squeeze to reach contradiction in 5 steps. 34k thinking tokens, 75-line proof, Q.E.D.
